 ...
 const pushToDatabase = async (items:  object[], summary: string, bot: string) => {
  ...
  // console.log(filteredItems);
    const conv_summary = await openai.chat.completions.create({
      model: "gpt-4o",
      messages: [
        {"role": "system", "content": "You are a assistant helping a parent summarize their child's conversations with an AI bot. Summarise the input concisely, picking out content that a parent might want to know about. Inlude any important quotes and details that might be relevant to the parent. Quotations should be vertabim ."}, 
    ...
    await pushToDatabase(filteredItems, String(conv_summary.choices[0].message.content) , "Comrade Charlie");
